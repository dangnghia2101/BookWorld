    ...
    <Block flex alignCenter paddingTop={56} backgroundColor={'white'}>
      ...
      <ModalPoup visible={visible2}>
        <Block alignCenter={'center'}>
          ...
          <Text marginTop={18} center style={styles.textPhone}>
            Đặt lại mật khẩu mới cho tài khoản của bạn để có thể đăng nhập.
          </Text>
          <Block style={styles.textPhoneContainer}>
            <TextInput style={styles.textInputOTP} placeholder={'Mật khẩu'} />
            <TextInput
              marginTop={20}
      ...
      <ModalPoup visible={visible1}>
        <Block alignCenter={'center'}>
          ...
          <Pressable style={styles.buttomLogin} onPress={() => status(2)}>
            <Text style={styles.textButtomLogin} height={55}>
              Tiếp tục
            </Text>
          </Pressable>
      ...
      <ModalPoup visible={visible}>
        <Block alignCenter={'center'}>
          ...
          <Text marginTop={18} center style={styles.textPhone}>
            Nhập số điện thoại của bạn cho quy trình xác minh. Chúng tôi sẽ gửi
            mã 4 chữ số cho bạn.
          </Text>
          <Block style={styles.textPhoneContainer}>
            <TextInput
          ...
          <Pressable style={styles.buttomLogin} onPress={() => status(1)}>
            <Text style={styles.textButtomLogin} height={55}>
              Tiếp tục
            </Text>
          </Pressable>
